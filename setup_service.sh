...
echo "cape_enable=bone_capemgr.enable _partno=BBBIO-JKPWM" >> /boot/uEnv.txt
echo "cape_enable=bone_capemgr.enable _partno=BB-ADC" >> /boot/uEnv.txt
echo "cape_enable=bone_capemgr.enable _partno=hcsr04" >> /boot/uEnv.txt
